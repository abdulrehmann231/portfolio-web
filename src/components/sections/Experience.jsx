        ...
        <section id="experience" className="py-20 relative">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="max-w-4xl mx-auto divide-y divide-slate-200 dark:divide-slate-800 border-y border-slate-200 dark:border-slate-800">
                        {experiences.map((exp, index) => (
                            ...
                            >
                                <div className="flex flex-col md:flex-row md:items-start justify-between mb-5 gap-4">
                                    <div>
                                        <h3 className="text-2xl font-bold text-slate-950 dark:text-white group-hover:text-slate-600 dark:group-hover:text-slate-400 transition-colors">{exp.title}</h3>
                                        <div className="text-lg text-slate-500 dark:text-slate-400 font-medium flex items-center gap-2 mt-2 flex-wrap">
                                            ...
                                            {exp.company}
                                            <span className="text-xs bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-2 py-1 rounded-full text-slate-700 dark:text-slate-300">
                                                {exp.type}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="text-slate-500 dark:text-slate-400 font-medium flex items-center gap-2 bg-white dark:bg-slate-900 self-start px-4 py-2 rounded-full border border-slate-200 dark:border-slate-800">
