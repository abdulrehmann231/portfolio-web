                    ...
                    <div className="grid md:grid-cols-2 gap-16 relative z-10">
                        <div>
                            ...
                            <div className="space-y-6">
                                <a href="mailto:mabdulrehman951@gmail.com" className="flex items-center gap-4 text-slate-700 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white group transition-colors p-4 surface-strong rounded-2xl hover:translate-y-[-1px]">
                                    <div className="p-3 bg-slate-50 dark:bg-slate-800 rounded-xl text-slate-700 dark:text-slate-300 group-hover:scale-110 transition-transform">
                                        <Mail size={24} />
                                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 surface-strong p-8 rounded-2xl border border-slate-200 dark:border-slate-800">
                            <div>
